...
async function onSearchInput() {
    ...
    for(var i = 0; i < showTopics.length; i++) {
        ...
        var img = document.createElement("img");
        img.classList.add(...["card-img-top", "h-75"])
        img.src = "http://localhost:8080/images/topiclogos/" + output[showTopics[i]]["topicImageLocation"]
        ...
        var h5 = document.createElement("h5");
        h5.classList.add("card-title")
        h5.innerHTML = output[showTopics[i]]["topicName"]
        var p = document.createElement("p");
        p.classList.add("card-text")
        p.innerHTML = output[showTopics[i]]["topicDescription"]
        ...
        var a = document.createElement("a")
        a.setAttribute("href", "quizpage.html?topic="+output[showTopics[i]]["topicName"])
        a.classList.add(...["btn", "btn-success", "w-100"])
        a.innerHTML = "Attempt"
